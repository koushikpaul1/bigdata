...
object RunIntro extends Serializable {
  def main(args: Array[String]): Unit = {
    ...
    val MatchDatas = parsed.as[MatchDatas]
    val scored = MatchDatas.map { md =>
      (scoreMatchDatas(md), md.is_match)
    }.toDF("score", "is_match")
  ...
  def scoreMatchDatas(md: MatchDatas): Double = {
