object LearningScala1 {
  ...
  val hello: String = "Hola!s"                    //> hello  : String = Hola!s
  println(hello)                                  //> Hola!s
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Hola!s
  helloThere = hello + " There!"
  println(helloThere)                             //> Hola!s There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Hola!sThere!
  println(immutableHelloThere)                    //> Hola!sThere!
