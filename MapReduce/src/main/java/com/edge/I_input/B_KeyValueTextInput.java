...
* input/misc/KeyValueTextInput output/KeyValueTextInput
* input/misc/KeyValueTextInputComaSeparated output/KeyValueTextInputComaSeparated
*/

public class B_KeyValueTextInput extends Configured implements Tool {
	public static void main(String args[]) throws Exception {
		String log4jConfPath = "log4j.properties";
		PropertyConfigurator.configure(log4jConfPath);
		int res = ToolRunner.run(new B_KeyValueTextInput(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(B_KeyValueTextInput.class);
