...
/** input/ncdc/NCDC output/MinimalMapReduceWithDefaults */

public class B_MinimalMapReduceWithDefaults extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new B_MinimalMapReduceWithDefaults(), args);
